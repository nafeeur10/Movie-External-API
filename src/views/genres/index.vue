...
<div class="container mx-auto">
    ...
    <ul class="flex flex-wrap justify-center mt-9">
        <li v-for="genre in genresList.slice(0, 8)" :key="genre.id" class="md:w-1/4 m-3 w-full">
            <a href="javascript:void(0)" @click="getActiveGenre(genre.id, genre.name)">
                <div class="bg-green-50 mx-auto max-w-sm shadow-lg rounded-lg overflow-hidden">
                    <div class="sm:flex flex-col sm:flex-row sm:items-center px-6 py-4">
                        <img class="block border rounded-full mx-auto mb-4 sm:mb-0 sm:mr-4 sm:ml-0 shadow-md p-3 w-14" src="https://img.icons8.com/color/48/000000/movie-projector.png" alt="">
